...
| T-655 역할별 운영 콘솔 메뉴 구조 재정의 | 진행 중 | P1 | PC 우선으로 원장/관리자 운영 콘솔과 선생님 수업 처리 메뉴를 분리 | T-635 제품 방향 문서 | PR 확인 후 main 반영 |
| T-656 출석부 장부형/테이블형 레이아웃 설계 | 대기 | P0 | PC 출석부를 학생 row 중심 장부형 구조로 설계 | T-655 메뉴 구조 정리 | T-655 이후 설계/구현 범위 확정 |
