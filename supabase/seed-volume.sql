-- Academy Follow-up volume seed data
-- 학생/스케줄이 많은 화면을 확인할 때만 MVP seed 실행 후 별도로 실행합니다.
-- 볼륨 데이터 정리가 필요하면 이 파일의 seed_pilot_volume_students ID 대역(333333333401~448)을 기준으로 삭제합니다.
